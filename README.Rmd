...
params: 
  ...
  bannerurl: "https://github.com/flor14/latinr-reprohack/raw/master/reprohack_latinr_banner.png"
  registration_url: https://www.eventbrite.com.ar/o/reprohack-en-latinr-31351318695
  hackpad_url: https://etherpad.wikimedia.org/p/reprohack_latinr2020
  intro_slides_url: "https://flor14.github.io/latinr-reprohack/docs/index.html#1"
  submission_url: https://forms.gle/vMk25vCevMg2QiYQ9
  feedback_url: https://forms.gle/b8TvEMxeeUY9gDFz7
...
**Lista actual de artículos propuestos** [`r emo::ji("es")`](https://sheffield-university.shinyapps.io/latinr2020-reprohack-es/)[`r emo::ji("uk")`](https://sheffield-university.shinyapps.io/latinr2020-reprohack/)
...
if(!is.null(params$registration_url)){
  cat(paste0("### [**REGISTRARSE como participante**](", params$registration_url, ")"))
}
```
...
- [**Introducción Diapositivas**](`r params$intro_slides_url`) Instrucciones y enlaces
- **Lista de artículos** [`r emo::ji("es")`](https://sheffield-university.shinyapps.io/latinr2020-reprohack-es/)[`r emo::ji("uk")`](https://sheffield-university.shinyapps.io/latinr2020-reprohack/) Lista de trabajos postulados por sus autores
- [**EtherPad**](`r params$hackpad_url`) Cuaderno colaborativo para el día del evento
- [**Formulario de comentarios**](`r params$feedback_url`) Registro comentarios para los autores
...
#### **Introducción y bienvenida** [diapositivas](`r params$intro_slides_url`)

#### **1. Revisión de trabajos y formación de equipos**

Comenzaremos con una breve revisión de los [**artículos propuestos**](https://sheffield-university.shinyapps.io/latinr2020-reprohack-es/) y luego formar equipos. Siéntase libre de trabajar por su cuenta si lo prefiere.
...
Complete el [**Formulario de comentarios para los autores**](`r params$feedback_url`). Por favor, sea 
